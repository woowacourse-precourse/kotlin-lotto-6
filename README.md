...
- [x] "구입금액을 입력해 주세요." 출력
- [x] "{발행한 로또 수량}개를 구매했습니다." 출력
  - [x] 구입 금액에 해당하는 만큼 "[{발행한 로또 번호}]" 출력
- [x] "당첨 번호를 입력해 주세요." 출력
- [x] "보너스 번호를 입력해 주새요." 출력
- [x] "당첨 통계" 출력
- [x] "---" 출력
- [x] 당첨 내역
  - [x] "3개 일치 (5,000원) - 1개" 형식으로 출력
  - [x] "4개 일치 (50,000원) - 0개" 형식으로 출력
  - [x] "5개 일치 (1,500,000원) - 0개" 형식으로 출력
  - [x] "5개 일치, 보너스 볼 일치 (30,000,000원) - 0개" 형식으로 출력
  - [x] "6개 일치 (2,000,000,000원) - 0개" 형식으로 출력
- [x] "총 수익률은 62.5%입니다." 형식으로 출력
- [x] "[ERROR] 로또 번호는 1부터 45 사이의 숫자여야 합니다." 형식으로 [ERROR]로 시작하는 출력
...
- [ ] 로또 구입 금액이 1,000으로 나누어 떨이지는지 확인
- [ ] 당첨 번호가 쉼표를 기준으로 구분되는지 확인
- [ ] 로또 번호의 숫자 범위는 1~45인지 확인
- [ ] 로또 번호가 로또 숫자 6개인지 확인
...
- [x] 로또 번호와 당첨 번호 비교
  - [x] 1등: 6개 번호가 일치 하는지 확인
  - [x] 2등: 5개 번호와 보너스 번호 일치 하는지 확인
  - [x] 3등: 5개 번호 일치 하는지 확인
  - [x] 4등: 4개 번호 일치 하는지 확인
  - [x] 5등: 3개 번호 일치 하는지 확인
