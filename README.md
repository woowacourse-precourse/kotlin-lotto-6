...
- [x] "---" 출력
- [x] 당첨 내역
  - [ ] "3개 일치 (5,000원) - 1개" 형식으로 출력
  - [ ] "4개 일치 (50,000원) - 0개" 형식으로 출력
  - [ ] "5개 일치 (1,500,000원) - 0개" 형식으로 출력
  - [ ] "5개 일치, 보너스 볼 일치 (30,000,000원) - 0개" 형식으로 출력
  - [ ] "6개 일치 (2,000,000,000원) - 0개" 형식으로 출력
- [ ] "총 수익률은 62.5%입니다." 형식으로 출력
- [ ] "[ERROR] 로또 번호는 1부터 45 사이의 숫자여야 합니다." 형식으로 [ERROR]로 시작하는 출력
