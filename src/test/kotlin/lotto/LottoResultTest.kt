...
class LottoResultTest {
    ...
    fun `구입한 로또 번호와 당첨 번호 6개가 일치하는 경우`() {
        ...
        assertThat(count).isEqualTo(MatchNumber.SIX_MATCH.value)
    }
    ...
    fun `구입한 로또 번호와 당첨 번호 5개가 일치하는 경우`() {
        ...
        assertThat(count).isEqualTo(MatchNumber.FIVE_MATCH.value)
    }
    @Test
    fun `구입한 로또 번호와 당첨 번호 4개가 일치하는 경우`() {
        ...
        assertThat(count).isEqualTo(MatchNumber.FOUR_MATCH.value)
    }
    @Test
    fun `구입한 로또 번호와 당첨 번호 3개가 일치하는 경우`() {
        ...
        assertThat(count).isEqualTo(MatchNumber.THREE_MATCH.value)
    }
    @Test
