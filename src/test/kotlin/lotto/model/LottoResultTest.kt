...
class LottoResultTest {
    ...
    @CsvSource(
        value = ["1,2,3,4,5,6,${RANKING_1ST_INDEX}",
            "1,2,3,4,5,7,${RANKING_2ST_INDEX}",
            "1,2,3,4,5,8,${RANKING_3ST_INDEX}",
            "1,2,3,4,10,11,${RANKING_4ST_INDEX}",
            "1,2,3,41,42,43,${RANKING_5ST_INDEX}"],
        delimiter = ','
    )
