...
class Money(private val price: String) {
    init {
        ...
        require(price.toInt() in 1_000..100_000) { Error.AMOUNT_OVER_MAX_LIMIT.message }
        require(price.toInt() % 1_000 == 0) { Error.PURCHASE_IN_THOUSAND_WON.message }
    }
    ...
    private enum class Error(val message: String) {
        ...
        AMOUNT_OVER_MAX_LIMIT("[ERROR] 최소 1,000원 부터 최대 100,000원 까지 구매가 가능합니다."),
