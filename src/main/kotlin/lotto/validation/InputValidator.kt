...
object InputValidator {
    ...
    private const val EXCEPTION_PREFIX: String = "[ERROR]"
    ...
    fun checkInputEmpty(input: String) {
        require(input.isNotEmpty()) {
            "$EXCEPTION_PREFIX 구입 금액이 입력되지 않았습니다."
        }
    }
