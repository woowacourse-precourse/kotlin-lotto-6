...
class Constants {
    companion object{
        ...
        const val ERROR_INVALID_LOTTO_AMOUNT_1000_EXCEPTION_MESSAGE = "[ERROR] 입력된 금액이 1000원 단위가 아닙니다. 1000원, 2000원, 3000원과 같이 1000원 단위로 입력해 주세요."
        const val ERROR_INVALID_NOT_NUMBER_LOTTO_AMOUNT_MESSAGE = "[ERROR] 입력값에 숫자 이외의 문자가 포함되어 있습니다. 숫자만 입력해 주세요."
        const val ERROR_INVALID_NUMBER_COUNT_MESSAGE = "[ERROR] 입력된 숫자의 개수가 6개 이상입니다. 6개의 숫자만 입력해 주세요."
        const val ERROR_INVALID_WINNING_NUMBER_NEGATIVE_MESSAGE = "[ERROR] 번호에 음수가 포함되어 있습니다. 양수로만 입력해 주세요."
