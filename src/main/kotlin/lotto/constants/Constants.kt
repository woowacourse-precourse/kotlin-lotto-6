...
const val MESSAGE_NOT_SIX = "[ERROR] 6개를 입력해야 합니다."
const val MESSAGE_NOT_IN_RANGE = "[ERROR] 1 ~ 45사이의 숫자만 입력해야 합니다."
const val MESSAGE_CONTAIN_WINNING_NUMBER = "[ERROR] 당첨 번호에 포함된 숫자는 입력할 수 없습니다."