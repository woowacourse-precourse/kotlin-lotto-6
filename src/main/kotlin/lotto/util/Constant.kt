...
object Constant {
    ...
    const val INPUT_WINNING_NUMBER_MESSAGE = "당첨 번호를 입력해 주세요."
    const val INPUT_WINNING_NUMBER_OVERLAP_ERROR_MESSAGE = "[ERROR] 당첨 번호는 겹치면 안됩니다."
    const val INPUT_WINNING_NUMBER_NOT_NUMBER_ERROR_MESSAGE = "[ERROR] 당첨 번호는 1부터 45 사이의 숫자여야 합니다."
    const val INPUT_WINNING_NUMBER_LENGTH_ERROR_MESSAGE = "[ERROR] 당첨 번호는 6개의 숫자입니다."
