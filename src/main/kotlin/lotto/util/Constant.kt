...
const val WRONG_SEPARATOR = "잘못된 기호 입니다. 번호 구분용 기호로 쉼표(,)를 입력해 주세요."
const val DUPLICATE_NUMBER_EXCEPTION = "잘못된 입력값 입니다. 중복값 없도록 입력해 주세요."
const val DUPLYCATE_BONUS_EXCEPTION = "잘못된 입력값 입니다. 로또 당첨 번호와 중복하지 않는 값을 입력해 주세요."
