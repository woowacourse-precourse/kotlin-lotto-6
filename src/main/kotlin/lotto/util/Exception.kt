...
object Exception {
    ...
    fun validateInputLuckyNumber(numbers: String) {
        ...
        require(luckyNumbers.count {
            luckyNumber -> luckyNumber.toIntOrNull() == null || luckyNumber.toInt() !in LOTTO_MIN_RANDOM_NUMBER..LOTTO_MAX_RANDOM_NUMBER } == 0)
        { INPUT_LUCKY_NUMBER_NOT_NUMBER_ERROR_MESSAGE }
